...
public class GetUserHistoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            listUserHistory = userDAO.getUserHistory(nameUser);

            if (listUserHistory != null) {
                request.setAttribute("listUserHistory", listUserHistory);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(GetUserHistoryServlet.class.getName()).log(Level.SEVERE, null, ex);
