...
public class CheckEditServlet extends HttpServlet {
     ...
     */
    private final String UPDATESERVLET = "GetInforServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.setAttribute("choiceAction", "updateQuestion");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CheckEditServlet.class.getName()).log(Level.SEVERE, null, ex);
