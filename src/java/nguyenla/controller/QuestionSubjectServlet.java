 ...
 * @author ANH NGUYEN
 */
public class QuestionSubjectServlet extends HttpServlet {
     ...
     */
    private final String QSUBJECT = "QuestionSubject.jsp";
    private String url;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try(PrintWriter out = response.getWriter()){
            ...
            request.setAttribute("choiceAction",action);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(QuestionSubjectServlet.class.getName()).log(Level.SEVERE, null, ex);
