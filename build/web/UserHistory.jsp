                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <c:if test="${role eq 'student'}">
                            <form class="form-inline my-2 my-lg-0" action="searchHistory">
                                ...
                                <br>
                                &nbsp;
                                <input class="form-control mr-sm-2" type="search" placeholder="Course Name" aria-label="Search" name="txtSearch">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="HistoryDetails">
                                                <input type="submit" name="historyDetails" value="History Details" />
                                                <input type="hidden" name="hiddenIdHistory" value="${s.idHistory}"/>
                                            </form>
                                        </td>
                                    </tr>
                                </c:forEach>
